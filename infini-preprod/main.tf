locals {
  ...
  db_identifier           = "denzi-preprod-instance"
  db_instance             = "mysql-denzi-preprod-instance"
  tf_remote_state_bucket  = "denzi-preprod-remote-state"
  region                  = "us-east-2"
...
terraform {
  backend "s3" {
    bucket = "denzi-preprod-remote-state"
